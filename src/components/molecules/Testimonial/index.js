  ...
  return (
    <div className="py-16 parent bg-neutral ">
      ...
      >
        ...
        What are they saying about us?</h3>
        <h1 className="text-4xl font-semibold text-center">
        Testimonials <span className="text-primary">Customers</span>
        </h1>
        <BottomLine />
        <h2 className="py-5 text-center text-accent">Customer Satisfaction Is Our Top Priority</h2>
      </motion.div>
        ...
        <Slider {...settings}>
          {Reviews.map((review) => (
            <div key={review.id} className="mt-6">
              <div
                className="mx-4 rounded-lg shadow-xl single-blog cursor-pointer border-2 pt-6 flex flex-col justify-between h-[300px]"
