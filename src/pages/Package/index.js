      ...
      <div className="py-16 parent ">
        ...
        >
          <div className="mb-6">
            <h3 className="text-center text-accent">
              Book Promo Slots Immediately Before They Run Out!
            </h3>
            <h1 className="text-4xl font-semibold text-center">
            2024 New Year <span className="text-primary">Promo Package Prices</span>
            </h1>
            <BottomLine />
            <Countdown />
          </div>
        ...
        >
          <div className="flex flex-wrap items-center justify-center mt-2 mb-6">
            ...
            <button
              className={`btn btn-sm bg-primary border-2 border-primary text-white hover:bg-transparent hover:border-primary hover:text-primary duration-300 mx-3 my-3 sm:my-0 ${activeBtn === "onlineshop" && "active-btn"
                }`}
              onClick={() => {
                setActiveBtn("onlineshop");
                filterItem("onlineshop");
              }}
            >
              Website Toko Online
            </button>
          ...
          <div className="flex flex-wrap items-center justify-center mt-6 mb-6">
            {activeBtn === "wedding" && (
              ...
              Wedding <span className="text-primary">Website Creation Package</span>
              </h3>
            )}
            {activeBtn === "onlineshop" && (
              <h3 className="text-3xl font-semibold text-center" onClick={() => {
                filterItem("onlineshop");
                setActiveBtn("onlineshop");
              }}>
                Online Shop <span className="text-primary">Website Creation Package</span>
              </h3>
            )}
            {activeBtn === "companyprofile" && (
              <h3 className="text-3xl font-semibold text-center" onClick={() => {
                ...
                Company Profile <span className="text-primary">Website Creation Package</span>
              </h3>
            )}
          </div>
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 ">
            {items.map((item) => (
              ...
              >
                ...
                <span className="justify-center text-center package-featured">
                34% Discount</span>
                ...
                <span className="flex justify-center mb-5 ">
                  ...
                  >
                    <button className="flex items-center gap-3 text-black duration-500 bg-transparent border-2 btn border-primary hover:bg-primary hover:border-transparent hover:text-white">
                      ...
                      <span className="text-button-mobile">More Information</span>
                    </button>
                  </a>
                </span>
                <div className="w-full h-[1px] bg-primary inline-block align-bottom mb-4"></div>
                <div className="text-accent flex flex-auto flex-col justify-between">
